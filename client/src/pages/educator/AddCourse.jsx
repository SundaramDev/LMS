...
const AddCourse = () => {
  ...
  return (
    <div className="h-screen overflow-auto flex flex-col items-start md:p-8 p-4 pt-8">
      <form onSubmit={handleSubmit} className="w-full max-w-md flex flex-col gap-4 text-gray-500">
        {/* Course Title */}
            ...
            <div className="flex md:flex-row flex-col items-center gap-3">
              ...
              <label htmlFor="thumbnailImage" className="flex items-center gap-3">
                <img
                  ...
                  alt="Upload Icon"
                  className="w-5 h-5 p-2 bg-blue-500 rounded"
                />
                <input
                  type="file"
                  id="thumbnailImage"
